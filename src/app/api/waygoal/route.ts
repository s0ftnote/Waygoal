import { migrateLegacyOrigins } from "@/server/sessions/lineage-migration";
import { recoverForkOperations } from "@/server/sessions/fork-service";
import { NextResponse } from "next/server";
import { allowFileRoot } from "@/server/workspace/file-access";
import { getRpcSessionInfos, getRunningRpcSessionIds } from "@/server/agent/rpc-manager";
import { attachSessionProjectInfo, listAllSessions, mergeSessionLists } from "@/server/sessions/session-reader";
import { applyCanvasPatch, buildSnapshot, buildTicketSnapshot, canvasSessions, workspaceSessions, resolveWorkspaceCwd } from "@/server/canvas/store";
import { readTreeInfos } from "@/server/sessions/tree";
import { addCanvas, readWorkspaceRecord, recentWorkspaces, registerSession, rememberWorkspace, resolveScope, scopeFor } from "@/server/workspace/workspaces";
import type { WaygoalCanvasPatch, WaygoalSnapshotResponse } from "@/shared/waygoal-types";
