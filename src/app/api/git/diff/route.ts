...
import { getAllowedFileRoots, isExistingFilePathAllowed, isFilePathAllowed, isWindowsAbsolutePath } from "@/server/workspace/file-access";
import { getGitFileDiff } from "@/server/workspace/git-changes";
