...
import { hasJsonContentType, isApiRequestAllowed } from "@/server/http/request-security";
import { getProjectTrustStatus } from "@/server/workspace/project-trust";
import { isPluginSourceCheckable } from "@/server/extensions/plugin-updates";
import type {
  PluginDiagnostic,
  PluginPackageInfo,
