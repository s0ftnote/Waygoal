...
import { useGlobalKeyboardShortcuts } from "@/features/workspace/useKeyboardShortcuts";
import { SessionSidebar } from "../sessions/SessionSidebar";
import { ChatWindow } from "../chat/ChatWindow";
import type { ChatScrollPosition } from "@/features/chat/chat-scroll-position";
import { FileViewer } from "./FileViewer";
import { TabBar, type Tab } from "./TabBar";
import { openFileTab, saveFileViewerState } from "./file-tab-state";
import { SettingsPanel, SettingsSectionIcon } from "../settings/SettingsPanel";
import { ProjectTrustDialog } from "./ProjectTrustDialog";
import { BranchNavigator, hasSessionBranches } from "../sessions/BranchNavigator";
import { SystemPromptPanel } from "../chat/SystemPromptPanel";
import { ToolDefinitionsPanel } from "../chat/ToolDefinitionsPanel";
import { AgentSessionPanel } from "../sessions/AgentSessionPanel";
...
import { useIsMobile, useIsNarrowMobile } from "@/shared/hooks/useIsMobile";
import { useViewportHeight } from "@/shared/hooks/useViewportHeight";
import { useResizablePanel } from "@/features/workspace/useResizablePanel";
import { useAudio } from "@/features/chat/useAudio";
import { copyText } from "@/shared/clipboard";
import { sendAgentCommand } from "@/features/chat/agent-client";
import { getFileName } from "@/features/workspace/file-paths";
import { buildAtMentionText, buildFileAtMentionsText, buildFileLineMentionText } from "@/features/workspace/file-fuzzy";
import {
  claimExtensionAttentionNotification,
  shouldShowBrowserNotification,
  showBrowserNotification,
} from "@/shared/browser-notifications";
import { setupPushSubscription } from "@/shared/push-client";
import { getInitialNavigation } from "@/features/workspace/initial-navigation";
import { rekeyDraft } from "@/features/chat/draft-store";
import {
  clearLastOpen,
  getLastOpenSession,
  setLastOpenSession,
  workspaceKeyOf,
} from "@/features/workspace/workspace-memory";
import {
  ...
  SIDEBAR_MAX_WIDTH,
  SIDEBAR_MIN_WIDTH,
} from "@/features/workspace/panel-layout";
import type { BlockingExtensionUiRequest, SessionInfo, SessionTreeNode } from "@/shared/types";
import type { ProjectTrustStatus } from "@/shared/api-types";
import type { ChatInputHandle } from "../chat/ChatInput";
import type { SessionStatsInfo } from "@/shared/pi-types";
import type { FileViewerState } from "@/features/workspace/file-viewer-state";
import type { ToolEntry } from "@/features/chat/tool-presets";
import { getSessionFamily } from "@/features/sessions/session-family";
import { getLastSettingsSection, type SettingsSection } from "@/features/settings/settings-navigation";
...
export function AppShell() {
  ...
  const deliverSessionNotification = useCallback(({
    ...
    const fire = () => {
      const sessionUrl = targetSession ? `/chat?session=${encodeURIComponent(targetSession.id)}` : "/chat";
  ...
  const windowTitle = activeCwdName ? `${activeCwdName} - Waygoal` : "Waygoal";
