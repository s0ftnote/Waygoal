import { placeExpandedSessions } from "../canvas/session-expansion";
import { arrangeCards, type LayoutBox } from "../canvas/layout";
import { NODE_HEIGHT, NODE_WIDTH, ticketCardHeight, type WaygoalTicketMapCard } from "../../shared/waygoal-types";
