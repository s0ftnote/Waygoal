"use client";
import { registerAbortHandler } from "@/features/workspace/useKeyboardShortcuts";
import { useCallback, useEffect, useLayoutEffect, useMemo, useRef, useState, type ReactNode } from "react";
import { createPortal } from "react-dom";
import type { AgentMessage, AssistantContentBlock, AssistantMessage, BashExecutionMessage, BlockingExtensionUiRequest, ExtensionUiRequest, SessionInfo, SessionTreeNode, ToolResultMessage, UserMessage } from "@/shared/types";
import { normalizeCustomPanelLines } from "@/shared/ansi";
import { asBracketedPaste, toTerminalKeyData } from "@/features/workspace/terminal-input";
import { countToolCallBlocks, getAssistantErrorMessage, getDisplayableAssistantBlocks, isMessageGroupAnchor, splitFinalAssistantBlocks } from "@/features/chat/message-display";
import { extractTurnWrittenFiles, type WrittenFile } from "@/features/chat/turn-written-files";
import { buildQuotedSelection } from "@/features/chat/quoted-selection";
...
import { useAgentSession, type AgentPhase, type NoticeItem } from "@/features/chat/useAgentSession";
import { useDragDrop } from "@/features/workspace/useDragDrop";
...
import { findChatScrollAnchor, type ChatScrollPosition } from "@/features/chat/chat-scroll-position";
import {
  ...
  restoreScrollTop,
  VISIBLE_PAGE_SIZE,
} from "@/features/chat/chat-lazy-load";

import { materialSources, type MaterialSnapshot } from "@/features/materials/materials";
import { messageText } from "@/features/sessions/turns";
