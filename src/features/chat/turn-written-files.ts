import type { AssistantContentBlock, ToolResultMessage } from "../../shared/types";
import { resolveLocalFilePath } from "../workspace/file-links";
import { isEditToolName, isWriteToolName } from "../../shared/tool-names";
