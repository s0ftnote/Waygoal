...
const shellSource = await readFile(new URL("../workspace/AppShell.tsx", import.meta.url), "utf8");
const sidebarSource = await readFile(new URL("../sessions/SessionSidebar.tsx", import.meta.url), "utf8");
const themeSource = await readFile(new URL("../../shared/hooks/useTheme.ts", import.meta.url), "utf8");
const themeOptionsSource = await readFile(new URL("../../shared/theme.ts", import.meta.url), "utf8");
const enSource = await readFile(new URL("../../shared/i18n/messages/en.ts", import.meta.url), "utf8");
const zhSource = await readFile(new URL("../../shared/i18n/messages/zh-CN.ts", import.meta.url), "utf8");
