...
export interface WaygoalTurnLayout {
  takeaways?: Record<string, import("../features/materials/takeaways").TurnTakeaway>;
...
export interface WaygoalCanvasRecord {
  ...
  /** One reversible position-only arrangement, scoped to this canvas. */
  layoutUndo?: WaygoalLayoutChange;
  view?: WaygoalView;
