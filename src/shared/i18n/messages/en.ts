...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how Waygoal looks and which language it uses.",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Waygoal built-in sub-agents",
    "agents.builtInDescription": "Provides Waygoal's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "appUpdate.releaseNotes": "Waygoal v{version} is available. View release notes",
