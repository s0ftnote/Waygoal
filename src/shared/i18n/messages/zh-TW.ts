...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "設定",
    "settings.general": "一般",
    "settings.generalDescription": "選擇 Waygoal 的外觀與介面語言。",
    ...
    "agents.close": "關閉",
    "agents.builtInTitle": "啟用 Waygoal 內建子代理",
    "agents.builtInDescription": "提供 Waygoal 整合的 Agent 工具，並停用發生衝突的 pi-subagents 擴充功能。",
    ...
    "appUpdate.releaseNotes": "Waygoal v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    "theme.light": "主題：淺色",
    "theme.dark": "主題：深色",
