...
const appShellSource = await readFile(new URL("../../features/workspace/AppShell.tsx", import.meta.url), "utf8");
const chatWindowSource = await readFile(new URL("../../features/chat/ChatWindow.tsx", import.meta.url), "utf8");
const chatInputSource = await readFile(new URL("../../features/chat/ChatInput.tsx", import.meta.url), "utf8");
