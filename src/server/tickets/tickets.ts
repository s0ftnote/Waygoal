...
import { isExistingPathWithinRoots } from "../workspace/path-security";
import { mapLead, mapSections, sourceLinks } from "../../features/tickets/map";
import type { WaygoalReference, WaygoalSavedTickets, WaygoalStale, WaygoalTicketMap, WaygoalTicketMapView, WaygoalTicketNode, WaygoalTicketScan, WaygoalTicketState, WaygoalTicketView, WaygoalUnreadable } from "../../shared/waygoal-types";
...
export function parseTicket(id: string, body: string) {
