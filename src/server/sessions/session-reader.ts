...
import type { AgentMessage, ImageContent, SessionEntry, SessionHeader, SessionInfo, SessionContext } from "../../shared/types";
import { normalizeToolCalls } from "../../shared/normalize";
import { getThinkingPreview } from "../../features/chat/message-display";
...
import { resolveProject, type ProjectInfo } from "../workspace/worktree";
import { readSubagentRun, SUBAGENT_META_TYPE } from "../agent/subagents";
