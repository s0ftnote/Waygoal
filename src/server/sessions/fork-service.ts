...
import { applyCanvasPatch, readCanvasRecord } from "../canvas/store";
import { registerSession, resolveScope } from "../workspace/workspaces";
import { samePath } from "../workspace/paths";
import { waygoalRoot } from "../workspace/dirs";
