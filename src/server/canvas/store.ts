import { legacyOrigins, type MigrationItem } from "../sessions/lineage-migration";
import { readOrigin } from "../sessions/lineage";
import { randomBytes } from "node:crypto";
import { mkdirSync, realpathSync, statSync } from "node:fs";
import { isAbsolute, join, resolve } from "node:path";
import { getAgentDir } from "@earendil-works/pi-coding-agent";
import { writePrivateFileAtomicSync } from "../http/atomic-file";
import { isPathWithinRoots } from "../workspace/path-security";
import { samePath } from "../workspace/paths";
import { projectIdentityKey } from "../workspace/project-identity";
import { normalizeWorkspaceInput, readRecord, workspaceDir, workspaceId } from "../workspace/dirs";
import { claimSessionsOn, rememberedWorkspace } from "../workspace/workspaces";
import { nextFreePosition } from "../../features/canvas/layout";
import { validTakeaway } from "../../features/materials/takeaways";
import type { WaygoalLayoutChange, WaygoalTurnLayout } from "../../shared/waygoal-types";
export { nextFreePosition } from "../../features/canvas/layout";
import type { SessionInfo } from "../../shared/types";
import { REMOTE_PREFIX } from "../tickets/remote";
import { remoteMapViews } from "../tickets/remote-store";
import { mergeTicketScan, readLocalTickets } from "../tickets/tickets";
import { DEFAULT_CANVAS_ID, NODE_HEIGHT, NODE_WIDTH, TICKET_CARD_HEIGHT, type WaygoalScope, type WaygoalCanvasPatch, type WaygoalCanvasRecord, type WaygoalGroup, type WaygoalGroupView, type WaygoalManualLink, type WaygoalNode, type WaygoalNodeOrigin, type WaygoalOriginRecord, type WaygoalPoint, type WaygoalSavedTickets, needsCheck, type WaygoalMapCheck, type WaygoalSnapshot, type WaygoalTicketDiscussion, type WaygoalTicketMapView, type WaygoalTicketState, type WaygoalTicketSnapshot, type WaygoalTicketView, type WaygoalTitleSource, type WaygoalTreeInfo } from "../../shared/waygoal-types";
 ...
 *  npm preserves the launch directory in INIT_CWD.
