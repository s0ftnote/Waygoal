...
- **Git worktree**：スイッチャーの表示条件、worktree の作成、削除時の動作については [Worktrees in Pi Web](../../runtime/worktrees.md) を参照してください。
...
コントリビューター向けガイド：[Internationalization](../../runtime/i18n.md) と [Release process](../../runtime/release.md)。
...
アーキテクチャの説明と詳細なファイルマップについては [AGENTS.md](../../runtime/development-notes.md) を参照してください。
