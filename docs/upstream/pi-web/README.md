...
- **Git worktrees**: see [Worktrees in Pi Web](../../runtime/worktrees.md) for switcher visibility, worktree creation, and removal behavior.
...
Contributor guides: [Internationalization](../../runtime/i18n.md) and [Release process](../../runtime/release.md).
...
See [AGENTS.md](../../runtime/development-notes.md) for the architecture notes and detailed file map.
