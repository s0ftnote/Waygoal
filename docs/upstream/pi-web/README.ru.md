...
- **Git worktree**: условия отображения переключателя, создание рабочих деревьев и их удаление описаны в документе [Worktrees in Pi Web](../../runtime/worktrees.md).
...
Руководства для участников: [Internationalization](../../runtime/i18n.md) и [Release process](../../runtime/release.md).
...
Описание архитектуры и подробная карта файлов приведены в [AGENTS.md](../../runtime/development-notes.md).
